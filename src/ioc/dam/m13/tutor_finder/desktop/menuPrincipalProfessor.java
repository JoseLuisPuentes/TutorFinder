...
public class menuPrincipalProfessor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(labelTitol, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 220, 540, 90));
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 330, 830, 260));
        ...
        getContentPane().add(labelPublicacions3, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 300, 270, -1));
        getContentPane().add(textTitol, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 370, 260, -1));

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("Titol: ");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 370, 50, -1));

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel3.setText("Descripció: ");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 410, 100, -1));

        jTextAreaDescripcio.setColumns(20);
        jTextAreaDescripcio.setRows(5);
        jScrollPane2.setViewportView(jTextAreaDescripcio);

        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 410, 260, 110));
        ...
        getContentPane().add(buttonEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 320, 70, -1));
        ...
        getContentPane().add(buttonEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1060, 320, 80, -1));
        ...
        getContentPane().add(buttonCarregarDades, new org.netbeans.lib.awtextra.AbsoluteConstraints(1140, 320, 130, -1));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 540, 90, -1));
        ...
        getContentPane().add(comboCategoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 540, 260, -1));
        ...
        getContentPane().add(buttonMostrarPublicacions, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 470, -1, -1));
        ...
        getContentPane().add(buttonNou, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 320, 70, -1));
    ...
    private void buttonCreateAdsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonCreateAdsActionPerformed
        ...
        if(res){
            ...
            //Aqui mostrem a la taula les publicacions dels students. 
            ArrayList<AdDTO> ads1 = l.listAdsByRole(3);
            for (AdDTO ad : ads1) {
                System.out.println("----- Ads -----");
                System.out.println(ad.toString());
                System.out.println("--------------------");
    ...
    private void buttonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEditarActionPerformed
        ...
        System.out.println("Categoria: "+typeId);
        System.out.println("preu: "+numEntero);
        
        System.out.println("Abans de editar.");
        //Comprovem si ens retorna true o false
        boolean ret = l.editAd(id, title, description, typeId, numEntero);
    ...
    //Metode que mostra els anuncis nomes entrar a la pantalla del menu principal de tutor.
